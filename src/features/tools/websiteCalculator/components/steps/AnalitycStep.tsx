      ...
      {formData.purpose === 'client' && (
        <div className="bg-gradient-to-br from-primary/10 to-ring/20 border border-ring rounded-lg p-6 mb-6">
          ...
          <p className="text-sm text-primary mt-2">
            Includes professional setup, configuration, and tracking
            implementation
          </p>
        </div>
      )}
                  ...
                  <div className="rounded-lg border-2 border-foreground/20 p-4 bg-ring/20">
                    <div className="flex items-center justify-center h-full">
                      <div className="text-center">
                        <span className="inline-block px-3 py-1 bg-ring text-secondary rounded-full text-sm font-medium mb-2">
                          Premium Only Plugin
                        </span>
