        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-24 relative">
          ...
          <div className="space-y-6 md:space-y-8 text-center lg:text-left">
            <div className="flex justify-center lg:justify-start">
              <Badge
                text="Professional Website Cost Calculator"
                promo="100% Free"
                icon={Calculator}
              />
            </div>
            ...
            <p className="text-sm md:text-md text-foreground/80">
              Our advanced calculator provides detailed cost breakdowns for
              WordPress websites. Perfect for freelancers setting client rates
              or businesses planning their web projects. Get accurate estimates
              for hosting, design, development, plugins, and maintenance - all
              tailored to your specific needs.
            </p>

            <HeroButtonsSet
              firstBtnText="Build Your Dream Website Today"
              secondBtnText="Get Expert Web Consultation"
            />
            ...
            <Card className="relative bg-card/80 backdrop-blur-sm border-foreground/20 pt-4">
              <CardHeader>
                ...
                <p className="text-sm mb-4">
                  ...
                  Please review the following differences:
                </p>
                <ul className="text-sm text-foreground space-y-2 mb-4">
                  <li>
                    • If building yourself: You&apos;ll see actual costs of
                    tools, services, and resources needed.
                  </li>
                  <li>
                    • If charging clients: You&apos;ll see professional service
                    rates including labor costs, project management, and profit
                    margins.
                  </li>
                </ul>
              </CardHeader>
                ...
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <Label htmlFor="client">
                        I want to know how much to charge clients
                      </Label>
                    </div>
                  </RadioGroup>
                  {errors.purpose && (
                  ...
                  <div className="mt-4 p-4 bg-card rounded-lg border border-foreground/20">
                    <div className="flex items-start gap-2">
                      ...
                      >
                        I understand that pricing will be adjusted based on my
                        selection and agree to receive occasional marketing
                        emails. By proceeding, I accept the Terms of Service,
                        Privacy Policy, and acknowledge that my data will be
                        processed in accordance with the company&apos;s data
                        protection policies.
                      </label>
                    </div>
                    {errors.understood && (
